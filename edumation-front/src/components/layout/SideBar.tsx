...
const SideBar = () => {
  ...
  return (
    <div className="flex flex-col top-14 left-0 w-14 hover:w-48 md:w-48 bg-gray-300 dark:bg-gray-900 dark:text-white text-black transition-all duration-300 border-none z-10 sidebar">
